...
terminal        = "wezterm"
browser         = "brave"
# lock            = "i3lock-fancy-multimonitor -b=0x6"
# pywal           = "./.scripts/pywal && qtile cmd-obj -o cmd -f reload_config"
# pywal_random    = "./.scripts/pywal_random && qtile cmd-obj -o cmd -f reload_config"
# bg              = "./.scripts/bg.sh"
...
keys = [
    ...
    # LAUNCH PROGRAMS
    # --------------------------------------------------------------------------------------------
    Key([mod], "d", lazy.spawn(menu), desc="Application launcher"),
    ...
    # THEME
    # --------------------------------------------------------------------------------------------
    # Key([mod], "w", lazy.spawn(bg,shell=1), desc="Change wallpaper"),
    # Key([mod, "shift"], "w", lazy.spawn(bg_random,shell=1), desc="Change wallpaper randomly"),
    ...
    Key([mod], "m", lazy.window.toggle_maximize(), desc="Toggle maximize on the focused window"),
...
floating_layout = layout.Floating(
        ...
        border_normal = border_unfocused_color,
        border_width = 2,
    float_rules=[
        ...
        *layout.Floating.default_float_rules,
        ...
        Match(wm_class="pinentry-gtk-2"),  # gnome-pinentry
        Match(wm_class="pinentry-gtk"),  # gnome-pinentry
